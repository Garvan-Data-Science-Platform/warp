...
task CheckSamplesUnique {
  ...
  runtime {
    ...
    docker: "australia-southeast1-docker.pkg.dev/pb-dev-312200/warp/python:2.7"
  }
}
...
task CalculateAverageAnnotations {
  input {
    ...
    String docker = "australia-southeast1-docker.pkg.dev/pb-dev-312200/warp/gatk:4.6.0.0"
